...
font2 = pygame.font.Font('RussoOne-Regular.ttf', 20)
click = False
...
def mainTimer(waktu, level_value, heat_cap_value, read_mass) :
    ...
    while waktu >= 0 and timer_nyala : 
        ...
        #Tampilan UI
        pygame.draw.rect(Screen, BG_COLOR, (250,340,120,20))
        draw_text(f"{w_m}:{w_d}", font, WHITE, Screen, (250,340))
        draw_text("{:.1f}".format(temp_predict), font, WHITE, Screen, (320,340))
...
def main_loop():
    while True : 
        ...
        draw_text("00:00", font, WHITE, Screen, (250,340))
        draw_text("Temp", font, WHITE, Screen, (320,320))
        draw_text("27", font, WHITE, Screen, (320,340))
        ...
        if startbutton.collidepoint((mx,my)):
            if click:
                mainTimer(180, 0.7, 200, 200) #Parameter masih placeholder
