...
def main_loop():
    ...
    while True :
        ...
        for i in range(len(displayed_presets)) :
            if displayed_presets[i] != None :
                draw_text(displayed_presets[i][0], font, WHITE, Screen, (presetbuttons[i].centerx-25,presetbuttons[i].centery-5))

        draw_text("EcoMode", font, WHITE, Screen, (EcoMode.centerx-30, EcoMode.centery-5))
        
        draw_text("Save to Preset", font, WHITE, Screen, (savebutton.centerx-45, savebutton.centery-6))
        ...
        if startbutton.collidepoint((mx,my)):
            if click and waktu > 0:
                mainTimer(waktu, level_value, heat_cap_value, 200) #Parameter masih placeholder
